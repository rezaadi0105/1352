...
PS4["13.50"] = {
  fw_status:
    ...
    "kpatch=1350.bin-BUILT-10/10-neg-controls-pass-UNTESTED-on-hw payload=hen.bin-PS4HEN(works<=13.52) bug=663",
  ...
  payload: "hen.bin", // Scene-Collective PS4HEN 2.2.0; kpayload covers 13.02/04/50/52 via get_offsets_for_fw()
};
...
PS4["13.52"] = Object.assign({}, PS4["13.50"], {
  ...
  payload: "payload.bin", // official GoldHEN — 13.52 only
  fw_status:
...
PS4["13.02"] = Object.assign({}, PS4["13.00"], {
  ...
  payload: "hen.bin", // Scene-Collective PS4HEN 2.2.0; kpayload picks 13.02 table at runtime
  fw_status:
    ...
    "kpatch=1302.bin-HW-PROVEN-KEXEC-rc0 payload=hen.bin-PS4HEN(works<=13.52) bug=663",
});
...
PS4["13.04"] = Object.assign({}, PS4["13.00"], {
  ...
  payload: "hen.bin", // Scene-Collective PS4HEN 2.2.0; kpayload picks 13.04 table at runtime
  fw_status:
    ...
    "kpatch=1302.bin-shared-HW-PROVEN payload=hen.bin-PS4HEN(works<=13.52) bug=663",
});
